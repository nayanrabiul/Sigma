...
import { close, menu, SigmaLogo } from "../assets";
import { navLinks } from "../constants";
const Navbar = () => {
  const [toggle, setToggle] = useState(false);
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      <img src={SigmaLogo} alt={"hoobank Logo"} className=" w-[124px] h=[32px]" />
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div
          className={`${
            toggle ? "flex" : "hidden"
          }  p-6 bg-white shadow fixed top-24 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}
        >
